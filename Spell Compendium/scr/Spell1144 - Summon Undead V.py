...
def OnSpellEffect(spell):
    ...
    #ID 14828 = Shadow; ID 14954 = Wight; ID 14135 = Ghast; ID 14821 = Greater Temple Bugbear Zombie; ID 14128 = Ghoul; ID 14602 = Skeleton Guard; ID 14081 = Gnoll Skeleton; ID 14092 = Zombie 2HD; ID 14107 = Skeleton 1 HD
    ...
    #SummonMonster_Rectify_Initiative(spell, undeadToSummon) # Took this from Summon Monster
