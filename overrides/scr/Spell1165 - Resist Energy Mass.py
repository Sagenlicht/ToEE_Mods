...
def OnSpellEffect(spell):
    ...
    radialChoice = spell.spell_get_menu_arg(RADIAL_MENU_PARAM_MIN_SETTING) #1 = Acid; 2 = Cold, 3 = Electricity, 4 = Fire, 5 = Cold
    ...
    for spellTarget in spell.target_list:
        spellTarget.obj.condition_add_with_args('sp-Resist Elements', spell.id, elementType, spell.duration)
