...
def clearMindSpellBonusToMindAffecting(attachee, args, evt_obj):
    if evt_obj.flags & 0x8000000: #according to d20_defs.h: D20STD_F_SPELL_DESCRIPTOR_MIND_AFFECTING = 28,  // 0x8000000;
        ...
        evt_obj.bonus_list.add(4, 153,"~Clear Mind~[TAG_SPELLS_CLEAR_MIND] ~Sacred~[TAG_MODIFIER_SACRED] Bonus") #153 = Sacred; Clear Mind adds a +5 Sacred Bonus vs Mind-Affecting spells
    return 0
...
clearMindSpell.AddHook(ET_OnD20Signal, EK_S_Spell_End, spell_utils.spellEnd, ())
