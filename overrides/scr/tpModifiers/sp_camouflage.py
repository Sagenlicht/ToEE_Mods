...
def camouflageSpellBonusToHide(attachee, args, evt_obj):
    evt_obj.bonus_list.add(10, 21, "~Camouflage~[TAG_SPELLS_CAMOUFLAGE] ~Circumstance~[TAG_MODIFIER_CIRCUMSTANCE] Bonus")
    return 0
...
camouflageSpell.AddHook(ET_OnD20Signal, EK_S_Spell_End, spell_utils.spellEnd, ())
